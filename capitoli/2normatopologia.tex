...
\begin{figure}[!htb]
	\centering 
		...
		\resizebox{10cm}{6cm}{\includesvg{2nrm_stepf}}
...
\begin{figure}[!htb]
	\centering 
		\def\svgwidth{\columnwidth}
		\resizebox{10cm}{6cm}{\includesvg{2nrm_dicdelta}}
...
\begin{figure}[!htb]
	\centering 
		\def\svgwidth{\columnwidth}
		\resizebox{10cm}{6cm}{\includesvg{2nrm_absx}}
...
\begin{figure}[!htb]
	\centering 
		\def\svgwidth{\columnwidth}
		\resizebox{10cm}{6cm}{\includesvg{2nrm_tang}}
